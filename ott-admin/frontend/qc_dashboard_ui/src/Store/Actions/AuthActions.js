 ...
 */
export const signinUserSuccess = (user, fName, lName) => ({
   type: LOGIN_USER_SUCCESS,
   payload: { user, fName, lName }
});
 ...
 */
export const logoutUserFromFirebase = (history, dispatch) => ({
   type: LOGOUT_USER,
 ...
 */
export const logoutUserFromFirebaseSuccess = (message) => ({
