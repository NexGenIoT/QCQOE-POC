...
const listName = ['HLS', 'DASH'];

export default function HasFilter(props) {
  const { saveHasData, checkedItemHasData} = props;
  const [checked, setChecked] = React.useState(checkedItemHasData);
