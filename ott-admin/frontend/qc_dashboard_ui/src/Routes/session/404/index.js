      ...
      <QueueAnim type="bottom" duration={2000}>
         <div className="error-wrapper" key="1">
            ...
            <div className="session-inner-wrapper">
               <div className="row">
                  <div className="col-sm-12 col-md-12 col-lg-9 mx-auto" style={{"margin-top": "6rem"}}>
                     <div className="error-body text-center">
                        ...
                        <Button component={Link} to="/" variant="contained" className="Status-btn" style={{"color": "white","background": "#e20092","text-transform": "uppercase"}}>Go To Home Page</Button>
                     </div>
                  </div>
               </div>
            </div>
